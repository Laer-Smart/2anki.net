...
const NotionPreviewPage = import.meta.env.DEV
  ...
  : null;
const AnkifyPreviewPage = import.meta.env.DEV
  ? lazy(() => import('./pages/AnkifyPreviewPage/AnkifyPreviewPage'))
  : null;
    ...
    <BrowserRouter>
      ...
      >
        ...
        <Routes>
          ...
          {AnkifyPreviewPage && (
            <Route path="/dev/ankify-preview" element={<AnkifyPreviewPage />} />
          )}
          <Route
            path="/import"
