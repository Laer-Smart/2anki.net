...
export function countVisionTokens(dimensions: VisionImageDimensions): VisionTokenResult {
...
export const VISION_TOKEN_CEILING: number = process.env.VISION_TOKEN_CEILING_OVERRIDE
