...
The single egress point for every outbound third-party call (Notion, Anthropic, Dropbox, Google Drive, Patreon, Microsoft login, Apple login). Adds SSRF defence, latency/error metrics, and a query API for the ops dashboard.
